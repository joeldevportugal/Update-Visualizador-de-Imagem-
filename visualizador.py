...
def mostrar_imagem(event):
    ...
    # Tamanho máximo que a imagem deve ter
    max_width, max_height = 430, 530
    ...
    # Redimensionar a imagem com a nova largura e altura calculada
...
#-----------------------------------------------------------------------------------------------
# criar a Função Update ------------------------------------------------------------------------
def Update ():
    messagebox.showinfo("Update", " Nesta aplicação estive a corrigir O aspect ratio")
...
Janela.geometry('560x410+100+100')
Janela.resizable(0,0)
Janela.title('Visualizador Imagem Dev Joel 2024 PT com Update © ')
...
menu_ajuda.add_command(label="update", font=('arial 13 bold'), command=Update)
...
LFicheiros = Listbox(Janela, width=40, height=27)
...
scrollbar.place(x=675, y=10, height=435)  # Ajuste conforme necessário para alinhamento
